...
CREATE TABLE `schedules` (
  `id` int NOT NULL AUTO_INCREMENT,
  `schedulable_id` int DEFAULT NULL,
  `schedulable_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `date` date DEFAULT NULL,
  `time` time DEFAULT NULL,
  `rule` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `interval` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `day` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `day_of_week` text CHARACTER SET utf8 COLLATE utf8_unicode_ci,
